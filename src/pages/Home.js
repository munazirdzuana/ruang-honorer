...
const Home = () =>{
    ...
    <div>
        ...
        <NavigationBar page="Home"/>
            <div class="custom-shape-divider-bottom-1666449373">
                ...
                <Container className=" hero">
                    <Row className="d-flex align-items-center h-100">
                        <Col md className="d-flex text-align-center justify-content-center text-opacity-80 p-3">
                            <Row className="p-3 d-flex justify-content-center" >
                            <div className="fs-3 text-light fw-bold">"Setiap orang menjadi guru,
                        ...
                        <img src={hero} alt="Kelulusan" width= "80%" height="auto" className="d-none d-md-block"/>
                        </Col>
                </Row>
                </Container>
        </div>
